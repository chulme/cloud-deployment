		...
		stage('Send image tar to AWS via SSH'){
			steps{
				script{
						...
						bat "echo yes | ssh -i chris-aws-key.pem ubuntu@ec2-3-9-171-239.eu-west-2.compute.amazonaws.com tar -xvf python_file_detection/shared_workspace/tracker.tar.gz"
